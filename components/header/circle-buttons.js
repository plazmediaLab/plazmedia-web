...
export default function CircleButtons({ handleToggleMenu, ...props }) {
  ...
  return (
    <span {...props}>
      ...
      <ButtonToggleMenu
        ...
        className="bg-blueGray-100 rounded-full text-blueGray-500 dark:hover:text-font-light hover:bg-blueGray-200 dark:bg-blueGray-800 w-9 h-9 grid place-items-center md:hidden"
      />
    </span>
  );
}
